...
void configADC(void)
{
	...
	AdcRegs.INTSEL1N2.bit.INT1SEL   = 0;    //setup EOC1 to trigger ADCINT1 to fire		//1
	...
	AdcRegs.ADCSOC0CTL.bit.TRIGSEL  = 0x01; //  CPU Timer 0  // hierdie was 0x03
	AdcRegs.ADCSOC1CTL.bit.TRIGSEL  = 0x01; //					// hierdie was 0x03
